...
public class UsersController {
    ...
    public Map<String,Object> doLogin(String username, String password, HttpSession session){
        ...
        Users users = usersService.userList(username);
    ...
    public String toUser(Model model, @RequestParam(value = "pageNum",required = false)String pageNumUsers){
        int pageNum=1;
        if(pageNumUsers!=null&&pageNumUsers.isEmpty()==false){
            pageNum=Integer.parseInt(pageNumUsers);
        }
        int pageSize=1;
