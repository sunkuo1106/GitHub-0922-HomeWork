...
<div style="margin-left: 60px;margin-top:60px;width: 300px;height:200px;border: 1px solid pink">
...
<form method="post" action="/doAddUsers" enctype="multipart/form-data">
    <div style="margin-left: 450px;margin-top:-200px;width: 800px;height:400px;border: 1px solid pink">
        ...
        <p align="center">头像:<input type="text" name="picpathZJH"></p>
        <p align="center">
